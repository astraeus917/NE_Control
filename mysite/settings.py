...
SECRET_KEY = 'django-insecure-zlq#7=7ikhc-+5bhb7f8+5&53rk1^2yrkq+aysg$qo+!*hr61e'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.36.181.87', '192.168.3.2']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.change_password_form',
            ],
        },
    },
]
